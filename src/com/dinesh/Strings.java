...
public class Strings {
	...
	public static void main(String[] args) {
		...
		String s2 = "Fita";// s1 and s2 have same content so memory location will be same
		String s22 = "Java";
...
//		System.out.println("extract Java word from the sentence" + s7.substring(jIndex, jIndex + 4));
//        
